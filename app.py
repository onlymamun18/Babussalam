...
def get_present_list():
    ...
    now = datetime.now()
    t_str = f"{now.month}/{now.day}/{now.year}" # MM/DD/YYYY
    present_names = []
...
# ২. স্টুডেন্ট প্রোফাইল
    ...
    is_admin = st.sidebar.text_input("অ্যাডমিন পিন:", type="password") == "MdmamuN18"
    ...
    if sid and df_s is not None:
        ...
        if not student.empty:
            ...
            else: st.info("বিস্তারিত তথ্য দেখতে অ্যাডমিন পিন প্রয়োজন।")
...
# ৫. অ্যাডমিন অ্যাক্সেস
    ...
    if st.text_input("মাস্টার পিন দিন:", type="password") == "MdmamuN18":
        opt = st.selectbox("কাজ নির্বাচন করুন", ["হাজিরা নিন", "ছাত্র ব্যবস্থাপনা (ভর্তি/এডিট/ডিলিট)", "নোটিশ আপডেট"])
        ...
        # ছাত্র ব্যবস্থাপনা (নতুন ভর্তি, এডিট, ডিলিট)
            ...
            if sub_opt == "নতুন ভর্তি (Add)":
                with st.form("add_form"):
                    ...
                    if st.form_submit_button("ভর্তি নিশ্চিত করুন"):
                        ...
                        requests.post(SCRIPT_URL, json={"action": "admission", "id": v1, "name": v2, "father": v3, "mobile": v6, "photo": img})
                ...
                with st.form("edit_form"):
                    ...
                    if st.form_submit_button("তথ্য আপডেট করুন"):
                        # এখানে এডিট লজিক (গুগল স্ক্রিপ্টে 'edit' অ্যাকশন থাকতে হবে)
